    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 min-h-screen">
      ...
      {!image && !result && (
        <div className="flex flex-col items-center animate-[fadeIn_0.6s_ease-out] text-center mt-12">
          <h1 className="text-5xl md:text-7xl font-black text-transparent bg-clip-text bg-gradient-to-r from-blue-800 via-blue-600 to-yellow-500 mb-6 tracking-tight leading-tight drop-shadow-sm">
            Expert Analysis Suite <br /><span className="text-blue-200 text-3xl font-light">Historical Cryptography.</span>
          </h1>
          <p className="text-blue-100 text-lg mb-12 max-w-2xl font-light leading-relaxed">
          ...
          <div
            ...
            className="w-full max-w-2xl border-2 border-dashed border-blue-400 bg-white backdrop-blur-xl rounded-3xl p-16 flex flex-col items-center justify-center hover:bg-blue-100 hover:border-blue-400 transition-all cursor-pointer shadow-2xl group"
          >
            ...
            <h2 className="text-2xl font-heading text-blue-800 mb-3">Ingest New Archive</h2>
            <p className="text-blue-200">Secure entry for professional documentation</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
            ...
            <div className="lg:col-span-5">
              <div className="bg-museum-900/40 p-5 rounded-2xl border border-white/5 shadow-2xl backdrop-blur-xl sticky top-28">
                ...
                {!loading && !result && (
                  <button onClick={handleAnalyze} className="w-full bg-[#cfa341] text-museum-950 py-4 rounded-xl font-black text-xs tracking-[0.2em] uppercase hover:bg-gold-400 transition-all shadow-xl active:scale-95">
                      ...
                      <div className="animate-[fadeIn_0.3s]">
                        <div className="flex justify-between items-start mb-12 pb-8 border-b border-white/5">
                          <div className="space-y-1">
                            ...
                            <div className="text-3xl font-heading text-[#cfa341] font-black">{result.script}</div>
                          </div>
                          <div className="space-y-1 text-right">
                            <div className="text-[10px] text-slate-500 uppercase font-black tracking-widest">Chronology</div>
                            <div className="text-3xl font-heading text-[#cfa341] font-black">{result.era}</div>
                          </div>
                        </div>
                      ...
                      <div className="animate-[fadeIn_0.3s]">
                        ...
                        {translation && (
                          <div className="bg-black/20 p-8 rounded-xl border-t-2 border-gold-500 shadow-inner">
                            ...
                            <button onClick={() => speakText(translation, langCodes[lang])} className="bg-[#cfa341] text-museum-950 px-10 py-4 rounded-xl font-black tracking-widest uppercase text-[10px] shadow-lg hover:bg-gold-400 transition-all active:translate-y-1">
